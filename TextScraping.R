...
test_abstract <- read_html("https://journals.asm.org/doi/10.1128/aac.47.7.2125-2130.2003") %>%
  html_elements("section#abstract") %>%
  html_elements("[role = paragraph]")

test_abstract_text <- html_text(test_abstract)

test_body <- read_html("https://journals.asm.org/doi/10.1128/aac.47.7.2125-2130.2003") %>%
