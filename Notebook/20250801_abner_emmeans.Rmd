...
age_values <- seq(1, 120, 4) #c(12, 36, 60, 120)  # Adjust these as needed
...
ggplot(
    ...
    facet_wrap(~ container.title, nrow = 2, scale = "free_y", 
...
model_graph <-     
  ggplot(data = p, mapping = aes(x = age.in.months, y = predicted_citations, 
                                color = da_factor)) + 
