...
unnecessary text using R packages tm(text manipulation)((\textbf{tm?}))
and textstem ((21)), as well as converting all text to lowercase, and
the removal of digits and non-alphabetic characters such as whitespace.
To have the fewest number of unique words, we lemmatized (sort words by
...
meaningful number of words, we used the `Snowball' ((22)) dictionary of
...
a sparse matrix format useable by the R package mikropml ((23) ref),
using R packages caret and dplyr ((24), (25), (26)). Tokens were
...
status using R package emmeans ((28)). We also used R package sjPlot to
