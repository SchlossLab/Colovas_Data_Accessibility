...
*Microbiology Resource Announcements* at 99.83\%, and the lowest was
*Journal of Clinical Microbiology* at 13.44\%. Similarly to the new
sequencing data, this was expected as *Microbiology Resource
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/fract_da.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/time_da.png}}
...
and the lowest was *Microbiology Resource Announcements* at 1\%. To
further investigate the effects of time (age in months), the journal
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/model_predicted_plot.png}}

}

\caption{Predicted Number of Citations via Negative Binomial Model}

\end{figure}%

\pandocbounded{\includegraphics[keepaspectratio]{images/emmeans_contrast_plot.png}}
