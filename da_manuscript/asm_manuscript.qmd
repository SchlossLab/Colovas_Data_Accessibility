...
-   Results
    ...
    Two random forest models were trained to predict if published scientific papers "contained new sequence data" (NSD), and if the paper "had data available" (DA). The NSD model used an mtry value of 300 had an Area Under the Curve(AUC) of 0.9549 and an acccuracy of 0.8925. The sensitivity of the NSD model was 0.9130, and the specificity of the model was 0.8683. The DA model used an mtry value of 400 had an AUC of 0.9824 and an acccuracy of 0.9353. The sensitivity of the DA model was 0.9545, and the specificity of the model was 0.9005 (@Data/final/best_model_stats.csv for internal ref).


    Descriptive Statistics of the Whole Dataset
    - From 12 ASM journals, there were XXXX unique papers identified using the crossref, wos, ncbi, and scopus databases. After webscraping there were YYYY papers downloaded with text available for the models to be applied on. 
    ...
    -   Descriptive Statistics of the dataset
        ...
        - How many papers in the set have NSD? 
        - How many papers have DA? 
        - How many papers from each year/journal? 
    -   Regression modeling
...
- Figures/Tables/stats to make/get
    ...
    - % of papers nsd yes (training)
    - % of papers da yes (training)